...
public class WebBrowserViewController: UIViewController {
    ...
    private lazy var backButton: UIBarButtonItem = {
        let backIcon = UIImage(named: "backIcon", inBundle: NSBundle(forClass: self.dynamicType), compatibleWithTraitCollection: nil)
    ...
    private lazy var forwardButton: UIBarButtonItem = {
        let forwardIcon = UIImage(named: "forwardIcon", inBundle: NSBundle(forClass: self.dynamicType), compatibleWithTraitCollection: nil)
